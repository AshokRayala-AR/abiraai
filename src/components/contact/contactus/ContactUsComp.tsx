...
function ContactUSComp() {
    ...
    return(
        <div className="flex p-24 bg-[#101720] text-white">
...
<div className="flex gap-2">
    <button>
    <img src={fb} alt="fb" className="w-4" />
    </button>
    <button>
    <img src={twi} alt="twi" className="w-4" />
    </button>
    <button>
    <img src={li} alt="li" className="w-4" />
    </button>
    <button>
    <img src={insta} alt="insta" className="w-4" />
    </button>
</div>
</div>
...
<div className="w-3/6 flex justify-center items-center">
                ...
                <div className="bg-[#F6F3EE] w-4/6 p-8 flex flex-col gap-4 ">
