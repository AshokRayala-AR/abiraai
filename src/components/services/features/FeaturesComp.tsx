...
function FeaturesComp() {
    return (
            <div className=" total flex flex-col md:flex-row justify-center items-center gap-2 w-full p-12 md:p-20 md:px-16 bg-[#101720] md:h-screen">

<div className="b md:w-1/2 flex justify-start items-center h-full p-16 md:order-2">
                <div className="h-full relative flex items-center ">
                    <img src={featuresimg} className=" h-full z-10" />
                    <img src={circle} alt="circle" className="absolute -bottom-12 md:-bottom-14 left-1/4 md:left-2/4 lg:left-2/3"/>
                ...
                <div className="a md:w-1/2 md:p-12 flex flex-col items-center md:items-start justify-center gap-8 h-full ">
                    <div>
