...
function BusinessComp() {
    return(
        <div className="flex flex-col justify-center items-center bg-[#101720] p-12">
            ...
            <div className="flex flex-col gap-6 justify-center items-center  lg:w-3/6 text-center md:px-12">
                    ...
                    <p className="font-bold text-xl md:text-4xl text-white"> We Are Specialist We Offer for
                    Grow Your 
