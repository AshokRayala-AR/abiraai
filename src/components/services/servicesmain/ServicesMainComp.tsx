        ...
        <div className="relative flex justify-center items-center p-36 " >
            ...
            <div className="text-center flex flex-col gap-6 text-white">
                ...
                <p className="text-3xl font-bold">
                    Home &gt; <span className="text-transparent bg-gradient-to-r bg-clip-text from-purple-400 via-blue-400 to-cyan-400">Services</span>
                </p>
            </div>
        </div>
    );
...
export default ServicesMainComp;
