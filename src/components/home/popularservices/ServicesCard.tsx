...
function ServicesCards() {
  return (
    <div>
      <div className="flex flex-col flex-wrap md:flex-row gap-6 justify-center items-stretch">
        {ServicesData.map((item, index) => {
          return (
            <div
              key={index}
              className="bg-white w-1/6 p-4 rounded-t-[150px]  rounded-b-[150px] min-w-[170px] "
            >
